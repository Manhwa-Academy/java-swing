...
public class PhieuKiemKeDialog extends JDialog {
    ...
    public void loadImei() {
        String search = findImei.getText().trim();
        listMode.clear();

        for (int i = 0; i < 10; i++) {
            String imei = "123456" + i;
            if (search.isEmpty() || imei.contains(search)) {
                listMode.addElement(new CheckListItem(imei));
            }
        }
        ...
        list.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent event) {
                ...
                CheckListItem item = listMode.get(index);
